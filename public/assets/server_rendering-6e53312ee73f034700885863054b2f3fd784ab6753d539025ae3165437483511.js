...
var AddButton = (function (_React$Component) {
  ...
  _createClass(AddButton, [{
    ...
    value: function render() {
      ...
      var className = place ? 'btn-add-block-' + place : 'btn-add-block';
...
var AddForm = (function (_React$Component) {
  ...
  function AddForm() {
    ...
    _get(Object.getPrototypeOf(AddForm.prototype), 'constructor', this).apply(this, arguments);
  }
  ...
  _createClass(AddForm, [{
    ...
    value: function render() {
      ...
      var btnPlace = _props.btnPlace;
      var btnStyles = _props.btnStyles;

      var styles = btnStyles ? btnStyles : '';
      return React.createElement(
        'div',
...
var AnswerGroup = (function (_React$Component) {
  _inherits(AnswerGroup, _React$Component);

  function AnswerGroup() {
    _classCallCheck(this, AnswerGroup);

    _get(Object.getPrototypeOf(AnswerGroup.prototype), "constructor", this).apply(this, arguments);
  }

  _createClass(AnswerGroup, [{
    key: "render",
    value: function render() {
      return React.createElement(
        "ul",
...
var MainContainer = (function (_React$Component) {
  ...
  _createClass(MainContainer, [{
    ...
    value: function componentDidMount() {
      ...
      axios.get('/api/v1/subjects/all?deep=true').then(function (response) {
        return _this.setState({ subjects: response });
    ...
    value: function render() {
      return React.createElement(
        ...
        this.state.subjects && React.createElement(SubjectContainer, { subjects: this.state.subjects.data })
      );
    }
  }], [{
    key: 'propTypes',
...
var Question = (function (_React$Component) {
  ...
  _createClass(Question, [{
    key: 'handleTriggerShowForm',
    value: function handleTriggerShowForm() {
      this.setState({ showForm: !this.state.showForm });
    }
  }, {
    key: 'render',
    value: function render() {
      var answersProp = this.props.answers;
      var answers = answersProp && answersProp.map(function (answer, index) {
        return React.createElement(Answer, { key: index, answer: answer.answer });
      });
      ...
      return React.createElement(
        ...
        React.createElement(
          AnswerGroup,
          null,
          answers && answers.length > 0 ? answers : React.createElement(
            'div',
            null,
            React.createElement(
              'li',
            ...
            this.state.showForm ? React.createElement(AddForm, {
              btnPlace: 'under-search btn-form btn-answer',
              placeholder: 'Введите новый ответ...',
              onCancel: this.handleTriggerShowForm.bind(this) }) : React.createElement(AddButton, {
...
var QuestionContainer = (function (_React$Component) {
  ...
  function QuestionContainer() {
    ...
    _get(Object.getPrototypeOf(QuestionContainer.prototype), 'constructor', this).apply(this, arguments);
  ...
  _createClass(QuestionContainer, [{
    ...
    key: 'anyMatchInQuery',
    value: function anyMatchInQuery(name, query) {
      var nameArr = name.split(/\s|\,|\.|\!|\?|\:|\;/i),
          queryArr = query.split(/\s|\,|\.|\!|\?|\:|\;/i);

      var found = false;
      for (var i = 0; i < queryArr.length; ++i) {
        if (nameArr.indexOf(queryArr[i]) > -1 || this.searchStringInArray(queryArr[i], nameArr)) {
          found = true;
          break;
        }
      }
    ...
    value: function render() {
      ...
      var questionsProp = this.props.questions;
      var searchString = this.state.searchString.trim().toLowerCase();

      if (questionsProp && questionsProp.length > 0) {
        if (searchString.length) {
          questionsProp = questionsProp.filter(function (q) {
            return _this.anyMatchInQuery(q.question.toLowerCase(), searchString);
          });
        }
      }

      var questions = questionsProp && questionsProp.map(function (question, index) {
      ...
      return React.createElement(
        ...
        !this.state.showForm && React.createElement(SearchField, {
...
var SearchField = (function (_React$Component) {
  ...
  function SearchField(props, context) {
    _classCallCheck(this, SearchField);

    _get(Object.getPrototypeOf(SearchField.prototype), 'constructor', this).call(this, props, context);
    this.state = {
      value: ''
    };
  }
  ...
  _createClass(SearchField, [{
    key: 'render',
    value: function render() {
      var action = this.props.searchAction,
...
var Subject = (function (_React$Component) {
  ...
  function Subject() {
    ...
    _get(Object.getPrototypeOf(Subject.prototype), 'constructor', this).apply(this, arguments);
  }
  ...
  _createClass(Subject, [{
    ...
    value: function render() {
      ...
      var radioGroupName = _props.radioGroupName;
      var onClick = _props.onClick;
...
var SubjectContainer = (function (_React$Component) {
  _inherits(SubjectContainer, _React$Component);

  function SubjectContainer() {
    _classCallCheck(this, SubjectContainer);

    _get(Object.getPrototypeOf(SubjectContainer.prototype), 'constructor', this).apply(this, arguments);
  ...
  _createClass(SubjectContainer, [{
    ...
    value: function render() {
      ...
      var subjectsProp = this.props.subjects;

      var subjects = subjectsProp.map(function (subject, index) {
      ...
      var currentSubject = subjectsProp.find(function (subject) {
        return subject.name === _this.state.activeSubject;
      });
      var tests = currentSubject ? currentSubject.tests : undefined;
      ...
      return React.createElement(
        ...
        tests && tests.length > 0 ? React.createElement(TestContainer, { tests: tests }) : React.createElement(
          'div',
          { className: 'no-tests-block' },
          'Тестов пока что нет.',
          React.createElement(AddButton, { text: 'Добавить новый тест' })
        )
      );
    }
  }], [{
...
var TestContainer = (function (_React$Component) {
  ...
  function TestContainer() {
    ...
    _get(Object.getPrototypeOf(TestContainer.prototype), 'constructor', this).apply(this, arguments);
  ...
  _createClass(TestContainer, [{
    ...
    value: function render() {
      ...
      var testsProp = this.props.tests;
      var tests = testsProp.map(function (test, index) {
      ...
      var currentTest = testsProp && testsProp.find(function (test) {
        return test.name === _this.state.activeTest;
      });
      var questions = currentTest ? currentTest.questions : undefined;
      ...
      return React.createElement(
        ...
        questions && questions.length > 0 ? React.createElement(QuestionContainer, { questions: questions }) : React.createElement(
          'div',
          { className: 'no-questions-block' },
